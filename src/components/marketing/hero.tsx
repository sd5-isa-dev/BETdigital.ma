        ...
        <div className="flex flex-col items-center text-center w-full max-w-5xl my-24 mx-auto z-40 relative">
            ...
            <Container delay={0.1}>
                <p className="text-sm sm:text-base lg:text-lg mt-4 text-accent-foreground/60 max-w-2xl mx-auto">
                    Des études techniques précises et 100% digitalisées. Nous accompagnons les maîtres d'ouvrage et opérons en sous-traitance de confiance pour les bureaux d'études BTP.<span className="hidden sm:inline"></span>
                </p>
            </Container>
            <Container delay={0.2}>
