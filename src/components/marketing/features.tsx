            ...
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    ...
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        De votre dossier technique <br />à la validation, en 5 étapes
                    </h2>
                                    ...
                                    <div className="bento-card w-full relative items-center justify-center">
                                        <div className="w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                                            <p className="text-base text-muted-foreground text-justify [mask-image:radial-gradient(50%_50%_at_50%_50%,#BAB3FF_0%,rgba(186,179,255,0)_90.69%)]">
                                                We use AI to help you create content that resonates with your audience. Our tools are designed to optimize your content creation and engagement like never before. Transform your social media strategy with BET-digitalAI&apos;s cutting-edge features. Reach your audience with the right message at the right time. Create content faster and smarter with BET-digitalAI. Transform your social media strategy with BET-digitalAI&apos;s cutting-edge features. Create content faster and smarter with BET-digitalAI. Transform your social media strategy with BET-digitalAI&apos;s cutting-edge features. Create content faster and smarter with BET-digitalAI.
                                            </p>
                                        </div>
