        ...
        <div className="flex flex-col items-center justify-center py-12 md:py-16 lg:py-24 w-full">
            <Container>
                <div className="flex flex-col items-center text-center max-w-2xl mx-auto">
                    <SectionBadge title="Avantages" />
                    <h2 className="text-2xl md:text-4xl lg:text-5xl font-heading font-medium !leading-snug mt-6">
                        Un Bureau d&apos;Études Techniques 100% digital
                    </h2>
                    <p className="text-base md:text-lg text-center text-accent-foreground/80 mt-6">
                        BET-digital allie la rigueur d&apos;un bureau d&apos;études techniques traditionnel à la rapidité et à la transparence du digital, pour un accompagnement fiable à chaque étape de votre projet.
                    </p>
                </div>
            </Container>
            <Container>
