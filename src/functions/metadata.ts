...
export const generateMetadata = ({
    title = `${process.env.NEXT_PUBLIC_APP_NAME} Bureau d'études technique digital`,
    ...
    const metadataBase = new URL(process.env.NEXT_PUBLIC_APP_URL || "https://BET-digital-ai.vercel.app");
